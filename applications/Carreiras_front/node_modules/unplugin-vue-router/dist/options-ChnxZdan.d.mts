...
declare function resolveOptions(options: Options): {
    ...
    root: string;
    routeBlockLang: "json5" | "yaml" | "yml" | "json";
    dts: string | boolean;
    _inspect: boolean;
    logs: boolean;
    pathParser: ParseSegmentOptions;
...
export { DEFAULT_OPTIONS as D, EditableTreeNode as E, type LiteralStringUnion as L, type Options as O, type ResolvedOptions as R, type ServerContext as S, TreeNode as T, type _Awaitable as _, getPascalCaseRouteName as a, TreeNodeValueParam as b, createTreeNodeValue as c, TreeNodeValueStatic as d, type RoutesFolderOption as e, type RoutesFolderOptionResolved as f, getFileBasedRouteName as g, type _OverridableOption as h, type _RoutesFolder as i, type RoutesFolder as j, resolveOptions as k, mergeAllExtensions as m, resolveOverridableOption as r };
